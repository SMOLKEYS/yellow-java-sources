...
public class FoodDialog extends BaseDialog
{
    ...
    public final Dialog show(@NotNull final Team team) {
        ...
        super.cont.clear();
        super.cont.table(Tex.pane, FoodDialog::show$lambda$0).grow();
        super.cont.table(Tex.pane, FoodDialog::show$lambda$1).grow();
        super.cont.row();
        super.cont.table(Tex.pane, FoodDialog::show$lambda$2).grow();
