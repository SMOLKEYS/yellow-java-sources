...
public class AzenoPlanetGenerator extends PlanetGenerator
{
    ...
    public final Block getBlock(@NotNull final Vec3 position) {
        ...
        final float tnoise = Simplex.noise3d(super.seed, 6.65, 0.58, 0.3333333432674408, (double)tposition.x, (double)(tposition.y + 999.0f), (double)tposition.z);
    ...
    public final float rawHeight(@NotNull final Vec3 position) {
        ...
        return (Mathf.pow(Simplex.noise3d(super.seed, 6.65, 0.5, 0.3333333432674408, (double)tposition.x, (double)tposition.y, (double)tposition.z), 2.3f) + this.waterOffset) / (1.0f + this.waterOffset);
    }
}
